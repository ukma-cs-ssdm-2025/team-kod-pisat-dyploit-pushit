...
### 1. Якщо зробити іншу роль (не юзер, не модератор і не адмін), вона зможе змінювати, видаляти акаунти (потенційно й рецензії)

* **Класифікація**: error; high severity;
* **Частина коду**:
```
...
* **Чому вона небезпечна**: такий користувач може видалити будь-який акаунт 
* **Як можна виправити**: додати перевірку ролей (якщо не адмін/модератор/юзер - видавати помилку)

### 2. Відсутність таймаутів


* **Класифікація**: error; medium severity;
* **Частина коду:**
...
```
* **Чому вона небезпечна**: є можливість робити нескінченну кількість запитів і ти самим викликати зависання бази даних
* **Як можна виправити**: додати таймаути до викликів